...
public class Asteroid03 : MonoBehaviour {

    [Header("Basic Astroid03 Values")]
    private Rigidbody _RB;
    private float _SPEED;
    private int _hitpoints = 3;

    [Header("Constant Values of Astroid03")]
    const int _scoreValue = 80;
    ...
    void Start() {
        ...
        _SPEED = Random.Range(14.5f, 19.5f) * 3f;
        //Debug.Log("Asteroid 3 Speed: " + _SPEED);
    ...
    private void Update() {
        //Debug.Log("Asteroid 03 Hitpoints: " + _hitpoints);
        //Debug.Log("Asteroid 03 Position.z: " + gameObject.transform.position.z.ToString());
